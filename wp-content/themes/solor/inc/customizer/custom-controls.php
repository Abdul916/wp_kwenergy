...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Skyrocket_Custom_Control extends WP_Customize_Control {
		...
		protected function get_skyrocket_resource_url() {
			return SOLOR_THEME_URL . '/inc/customizer/';
		}
	}
	...
	class Skyrocket_Dropdown_Select2_Custom_Control extends Skyrocket_Custom_Control {
		...
		?>
			<div class="dropdown_select2_control">
				...
				<select name="select2-list-<?php echo esc_attr( $this->multiselect ? 'multi[]' : 'single' ); ?>" class="customize-control-select2" data-placeholder="<?php echo esc_html($this->placeholder); ?>" <?php echo esc_html( $this->multiselect ? 'multiple="multiple" ' : '' ); ?>>
					<?php
						if ( !$this->multiselect ) {
		...
		?>
			<div class="dropdown_posts_control">
				...
				<?php if( !empty( $this->description ) ) { ?>
					<span class="customize-control-description"><?php echo esc_html( $this->description ); ?></span>
				<?php } ?>
				<select name="<?php echo esc_html($this->id); ?>" id="<?php echo esc_html($this->id); ?>" <?php $this->link(); ?>>
					<?php
						if( !empty( $this->posts ) ) {
		...
		?>
		  <div class="wpcolorpicker_alpha_color_control">
				...
				<?php if( !empty( $this->description ) ) { ?>
					<span class="customize-control-description"><?php echo esc_html( $this->description ); ?></span>
				<?php } ?>
				<input type="text" class="wpcolorpicker-alpha-color-picker color-picker" id="<?php echo esc_attr( $this->id ); ?>" name="<?php echo esc_attr( $this->id ); ?>" value="<?php echo esc_attr( $this->value() ); ?>" <?php echo esc_html($this->attributes); ?> <?php $this->link(); ?> />
			</div>
		<?php
		}
	}
